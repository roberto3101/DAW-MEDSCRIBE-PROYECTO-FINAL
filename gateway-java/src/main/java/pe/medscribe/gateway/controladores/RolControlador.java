...
public class RolControlador {
    ...
    @PreAuthorize("hasRole('Administrador')")
    public ResponseEntity<?> cambiarEstado(@PathVariable Long idRol, @RequestBody Map<String, Object> cuerpo) {
        boolean estaActivo = Boolean.TRUE.equals(cuerpo.get("estaActivo"));
        rolServicio.cambiarEstado(idRol, estaActivo);
        return ResponseEntity.ok(Map.of("mensaje", "Estado del rol actualizado"));
    }
}
