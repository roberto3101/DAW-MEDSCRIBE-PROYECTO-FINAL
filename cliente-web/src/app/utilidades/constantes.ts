...
export const MODULOS_DISPONIBLES = ['pacientes', 'consultas', 'documentos', 'configuracion', 'usuarios', 'roles'] as const;
export const ACCIONES_DISPONIBLES = ['ver', 'crear', 'editar', 'eliminar'] as const;
