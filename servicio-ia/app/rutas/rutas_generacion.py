...
from app.servicios.configuracion_documentos import obtener_configuracion_de_documentos, DIRECTORIO_DATOS
import io
import os
import uuid
...
DIRECTORIO_DOCUMENTOS = os.path.join(DIRECTORIO_DATOS, "documentos-generados")
