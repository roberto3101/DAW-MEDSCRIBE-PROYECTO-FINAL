...
from app.servicios.configuracion_documentos import obtener_configuracion_de_documentos, guardar_configuracion_de_documentos, DIRECTORIO_DATOS
...
DIRECTORIO_LOGOS = os.path.join(DIRECTORIO_DATOS, "logos")
